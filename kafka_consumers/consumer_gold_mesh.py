...
KAFKA_TOPIC_GOLD_MESH = os.getenv("KAFKA_TOPIC_GOLD_MESH", "mesh.gold")
...
def main():
    ...
    consumer.subscribe([KAFKA_TOPIC_GOLD_MESH])
    print(f"[START]: Consumer MESH attivo su {KAFKA_TOPIC_GOLD_MESH}")
